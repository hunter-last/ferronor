...
public class FrmCobroCliente extends javax.swing.JDialog {
    ...
    private void configurarEstadoInicial() {
        ...
        // El panel Banco siempre comienza oculto.
        pnlSelectorCtaBancaria.setVisible(false);

        // El medio visual inicial, cuando exista una cuenta,
        // será Efectivo.
    ...
    private void configurarEventosManual() {
        ...
        // Estos dos botones NO tienen actionPerformed
        // generado por NetBeans en el .form.
        ...
        // Registrar Cobro tampoco tiene evento generado
        // en el .form.
        btnRegistrarCobro.addActionListener(
                e -> registrarCobro()
        );

        // Cancelar tampoco tiene evento generado.
        btnCancelar.addActionListener(
                e -> dispose()
        );

        // El monto sí necesita reaccionar mientras se escribe.
    ...
    private void habilitarComponentesCobro(
        ...
        /*
         * Al habilitar una cuenta seleccionada,
         * el medio inicial siempre es Efectivo.
         */
    ...
    private void mostrarMedioBanco() {
        ...
        if (!bancoDisponible) {
            ...
            /*
             * Si no había cuenta seleccionada,
             * tomamos la primera cuenta activa.
             */
            if (cuentaBancariaSeleccionada == null) {
    ...
    private void initComponents() {
        ...
        pnlRegistrarCobroLayout.setHorizontalGroup(
            ...
            .addGroup(pnlRegistrarCobroLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addGroup(pnlRegistrarCobroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(pnlRegistrarCobroLayout.createSequentialGroup()
                    ...
                    .addGroup(pnlRegistrarCobroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(pnlSaldosRegistrarCobro, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                        .addGroup(pnlRegistrarCobroLayout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(spnlTblDetalleCuentasCobrar)
                            .addComponent(jSeparator1)
                            .addComponent(pnlCuentasCobrar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(lblNCuentasCobrarFiltrosSeleccionados, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(pnlSelectorCtaBancaria, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(pnlCuentaSeleccionada, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(pnlCuentaSeleccionada, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblNCuentasCobrarFiltrosSeleccionados)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(pnlSelectorCtaBancaria, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
